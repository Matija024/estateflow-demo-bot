...
const STARTER_QUESTIONS = [
  "Gib mir einen Überblick zur Immobilie",
  "Erstelle einen groben Geschäftsplan", 
  "Was steht in Mietvertrag?",
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-semibold text-estate-text-primary mb-2">
